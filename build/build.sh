...
echo "Building https://github.com/zenreach/silk/commit/$LASTCOMMIT..."
...
function build {
	...
	echo "Version $VERSION - https://github.com/zenreach/silk/commit/$LASTCOMMIT" > $HERE/$dir/$thisdir/README.md
	echo "    (compressing)"
	cd $HERE
